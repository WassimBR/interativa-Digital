...
$CM=new CommentModel();
$idd = $_GET['id'];
$liste=$PM->AfficherSinglePost($idd);
//$liste=$CM->AfficherCommentById($idd);
...
<body>
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="post-heading">
                        <h1><?php echo ($Voi->GetTitle()); ?></h1>
                        <h2 class="subheading"><?php echo ($Voi->GetSubtitle()); ?></h2>
                        <span class="meta"> Posted on <?php echo ($Voi->GetDate()) ;?></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1"><hr>
<form name="sentMessage" id="contactForm" novalidate action="../control/Ajouter_comment.php" method="POST">
